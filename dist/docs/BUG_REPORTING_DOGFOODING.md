...
Each captured error may include an **Open in Business Central** link
...
dc navigation parameters. Their original ordering and URL encoding are preserved
so the saved link opens the same Business Central context. It is recipient-facing
