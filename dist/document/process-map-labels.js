(function (root, factory) {
  ...
  const EN_NODE_TITLES = Object.freeze({
    ...
    "document:demand-forecast": "Demand Forecast",
    "document:requisition-worksheet": "Requisition Worksheet",
    "document:order-planning": "Order Planning",
  ...
  const SV_NODE_TITLES = Object.freeze({
    ...
    "Make to Stock": "Tillverkning mot lager",
    "Make to Order": "Tillverkning mot order",
    "Assembly": "Montering",
    "Planning": "Planering",
    ...
    "document:demand-forecast": "Efterfrågeprognos",
    ...
    "Create Drop Shipment Purchase Order": "Skapa inköpsorder för direktleverans",
    "Post Purchase Receipt": "Bokför inköpsinleverans",
    "Post Purchase Invoice": "Bokför inköpsfaktura",
    "Create Assembly Order": "Skapa monteringsorder",
    ...
    "Enter Forecast Quantity": "Ange prognoskvantitet",
    "Review Forecast by Period": "Granska prognos per period",
    "Calculate Unfulfilled Demand": "Beräkna ouppfylld efterfrågan",
    "Review Demand Order": "Granska behovsorder",
