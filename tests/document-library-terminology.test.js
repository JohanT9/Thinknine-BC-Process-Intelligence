...
assert(dashboardHtml.includes('id="libraryFilterDisclosure"'));
assert(dashboardHtml.includes('id="libraryFilterCount"'));
assert(dashboardHtml.includes('id="libraryResetFilters"'));
