...
for (const sample of samples) {
  const { locale, page, field, create, journal, post, source, invoiceSource, walkthroughSource, taskLines, planningLines, invoiceQty, projectInvoice } = sample;
...
console.log('Project usage, planning-line navigation, invoice quantity, and project invoice actions match in all eight supported UI locales.');
