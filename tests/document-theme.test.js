...
assert.strictEqual(thinknine.colors.primary, "#007a82");
assert.strictEqual(thinknine.colors.text, "#172b45");
...
assert.strictEqual(customer.typography.title.color, "#172b45");
assert.strictEqual(customer.typography.heading1.color, "#ff0000");
assert.strictEqual(customer.colors.text, "#172b45");
