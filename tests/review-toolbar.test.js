...
undoButton.closest = selector => selector.startsWith("[data-review-") ? undoButton : null;
listeners.click({ target: undoButton });
assert.deepStrictEqual(executed, ["undo"]);
const disabledButton = buttons.get("redo");
disabledButton.closest = selector => selector.startsWith("[data-review-") ? disabledButton : null;
