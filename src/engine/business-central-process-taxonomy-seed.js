(function (root, factory) {
  ...
  const documentAliases = {
    ...
    "document:demand-forecast": ["Efterfrågeprognos", "Efterfrågeprognoser"],
    "document:requisition-worksheet": ["Inköpsförslag"],
    "document:order-planning": ["Orderplanering"],
  ...
  const primaryDomainByDocumentId = new Map([
    ...
    ["domain:forecast-to-plan", ["demand-forecast", "planning-worksheet",
      "requisition-worksheet", "order-planning"]],
  ...
  const documents = [
    ...
    ["document:demand-forecast", "Demand Forecast", "forecast", [
      view(2901, "card", "Demand Forecast Overview"),
      view(99000921, "list", "Demand Forecasts"),
      view(99000922, "list", "Demand Forecast Entries")], []],
    ["document:requisition-worksheet", "Requisition Worksheet", "worksheet",
      [view(291, "worksheet", "Requisition Worksheets")], ["246"]],
    ["document:order-planning", "Order Planning", "worksheet",
      [view(5522, "worksheet", "Order Planning")], ["246"]],
  ...
  const definitions = [
    ...
    { domainId: "domain:forecast-to-plan", businessId: "business-process:planning",
      ...
      documentIds: ["document:demand-forecast", "document:planning-worksheet",
        "document:requisition-worksheet",
        "document:order-planning",
        "document:purchase-order", "document:production-order"],
      steps: [
