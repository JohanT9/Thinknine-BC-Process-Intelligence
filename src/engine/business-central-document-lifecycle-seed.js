(function (root, factory) {
  ...
  const salesStages = [stage("sales:quote", "Quote", "document:sales-quote", { optional: true }),
    ...
    stage("sales:posted-warehouse-shipment", "Posted Warehouse Shipment",
      "document:posted-warehouse-shipment", { optional: true }),
    stage("sales:posted-sales-shipment", "Posted Sales Shipment",
      "document:posted-sales-shipment", { optional: true }),
    ...
    lifecycles: [
      lifecycle("lifecycle:sales", "Sales Document Lifecycle",
        ...
        [transition("sales:quote", "sales:order", "creates", { optional: true }),
          ...
          transition("sales:shipment", "sales:posted-warehouse-shipment", "postedAs", { variantIds: ["variant:basic-warehouse", "variant:direct-shipment"] }),
          transition("sales:pick", "sales:posted-warehouse-shipment", "postedAs", { variantIds: ["variant:advanced-warehouse"] }),
          transition("sales:posted-warehouse-shipment", "sales:posted-sales-shipment", "produces", { optional: true }),
          ...
          transition("sales:posted-sales-shipment", "sales:invoice", "derivedFrom", { optional: true }),
        ...
        [{ variantId: "variant:no-warehouse", stageIds: ["sales:order", "sales:invoice", "sales:posted-invoice"] },
          { variantId: "variant:basic-warehouse", stageIds: ["sales:order", "sales:shipment", "sales:posted-warehouse-shipment", "sales:posted-sales-shipment", "sales:invoice", "sales:posted-invoice"] },
          { variantId: "variant:advanced-warehouse", stageIds: ["sales:order", "sales:shipment", "sales:pick", "sales:posted-warehouse-shipment", "sales:posted-sales-shipment", "sales:invoice", "sales:posted-invoice"] },
          { variantId: "variant:direct-shipment", stageIds: ["sales:order", "sales:shipment", "sales:posted-warehouse-shipment", "sales:posted-sales-shipment"] },
