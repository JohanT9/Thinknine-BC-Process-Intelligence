(function (root, factory) {
  ...
  const concepts = [
    ...
    ["concept:get-source-documents", "Get Source Documents", ["Get Source Document"]],
    ["concept:post-warehouse-receipt", "Post Warehouse Receipt", ["Post Receipt"]],
    ["concept:create-warehouse-put-away", "Create Warehouse Put-away", ["Create Put-away"]],
    ["concept:put-away", "Register Put-away", ["Register Put Away"]],
    ["concept:transfer", "Transfer", ["Ship and Receive Transfer"]],
    ["concept:create-transfer-order", "Create Transfer Order", ["New Transfer Order"]],
    ["concept:post-transfer-shipment", "Post Transfer Shipment", ["Ship Transfer Order"]],
    ["concept:post-transfer-receipt", "Post Transfer Receipt", ["Receive Transfer Order"]],
  ...
  const diagrams = [
    ...
    reference("warehouse-receipt", "Warehouse Receipt", "domain:source-to-pay",
      "Warehouse Inbound", "Require Receive", [
        { title: "Purchase Order", type: "document", refs: ["document:purchase-order"] },
        { title: "Release", refs: ["concept:release"], edge: "releases" },
        { title: "Warehouse Receipt", type: "document",
          refs: ["document:warehouse-receipt"], edge: "creates" },
        { title: "Get Source Documents", type: "systemAction",
          refs: ["concept:get-source-documents"], edge: "references" },
        { title: "Post Warehouse Receipt", type: "posting",
          refs: ["concept:post-warehouse-receipt"], edge: "posts" },
        { title: "Posted Warehouse Receipt", type: "postedDocument",
          refs: ["document:posted-warehouse-receipt"], edge: "posts" }
      ]),
    reference("warehouse-put-away", "Warehouse Put-away", "domain:source-to-pay",
      "Warehouse Inbound", "Require Put-away", [
        { title: "Warehouse Receipt", type: "document", refs: ["document:warehouse-receipt"] },
        { title: "Post Warehouse Receipt", type: "posting",
          refs: ["concept:post-warehouse-receipt"], edge: "posts" },
    ...
    reference("warehouse-inbound", "Advanced Warehouse Inbound", "domain:source-to-pay",
    ...
    reference("transfer-order", "Transfer Order", "domain:transfers", "Inventory Transfer",
      "Standard", [{ title: "Transfer Order", type: "document", refs: ["document:transfer-order"] },
        { title: "Post Transfer Shipment", type: "posting",
          refs: ["concept:post-transfer-shipment"], edge: "transfersTo" },
        { title: "Posted Transfer Shipment", type: "postedDocument",
          refs: ["document:transfer-shipment"], edge: "posts" },
        { title: "Post Transfer Receipt", type: "posting",
          refs: ["concept:post-transfer-receipt"], edge: "transfersTo" },
        { title: "Posted Transfer Receipt", type: "postedDocument",
          refs: ["document:transfer-receipt"], edge: "posts" }]),
    reference("item-transfer", "Item Transfer", "domain:transfers", "Inventory Transfer",
      "Standard", [
        { title: "Transfer Order", type: "document", refs: ["document:transfer-order"] },
        { title: "Create Transfer Order", refs: ["concept:create-transfer-order"] },
        { title: "Post Transfer Shipment", type: "posting",
          refs: ["concept:post-transfer-shipment"], edge: "transfersTo" },
        { title: "Posted Transfer Shipment", type: "postedDocument",
          refs: ["document:transfer-shipment"], edge: "posts" },
    ...
    reference("production-lifecycle", "Production Order Lifecycle", "domain:plan-to-produce",
      "Production", "Make to Stock", [
        ...
        { title: "Finished Production Order", type: "postedDocument",
          refs: ["document:finished-production-order"] }]),
    reference("make-to-stock", "Make to Stock", "domain:plan-to-produce",
      "Production", "Make to Stock", [
        { title: "Planning Worksheet", type: "document",
          refs: ["document:planning-worksheet"] },
        { title: "Calculate Plan", refs: ["concept:plan"] },
        { title: "Create Production Order", refs: ["concept:production"], edge: "creates" },
        { title: "Production Order", type: "document", refs: ["document:production-order"] },
        { title: "Post Consumption", type: "posting",
          refs: ["concept:consume"], edge: "consumes" },
        { title: "Post Output", type: "posting", refs: ["concept:output"], edge: "produces" },
    ...
    reference("make-to-order", "Make to Order", "domain:plan-to-produce",
